...
const CreateNewProperty = () => {
    ...
    const addService = () => {
        ...
        if (!serviceName.trim() || !model.trim()) {
            alert("Service name and model should not be empty");
            return;
        }
        setServices([...services, { "name": serviceName, "model": model, "buyDate": buyDate ?  buyDate.startDate:"0000-00-00"}]);
        setServiceName('');
        setModel('');
    };
